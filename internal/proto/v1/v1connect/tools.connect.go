...
var (
	toolsServiceServiceDescriptor        = v1.File_proto_v1_tools_proto.Services().ByName("ToolsService")
...
type ToolsServiceClient interface {
	Unauthor(context.Context, *connect.Request[v1.UnauthorRequest]) (*connect.ServerStreamForClient[v1.ExploitResult], error)
	Httpx(context.Context, *connect.Request[v1.HttpxRequest]) (*connect.ServerStreamForClient[v1.ExploitResult], error)
}
...
func NewToolsServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ToolsServiceClient {
	...
	return &toolsServiceClient{
		unauthor: connect.NewClient[v1.UnauthorRequest, v1.ExploitResult](
			httpClient,
			baseURL+ToolsServiceUnauthorProcedure,
			connect.WithSchema(toolsServiceUnauthorMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		httpx: connect.NewClient[v1.HttpxRequest, v1.ExploitResult](
			httpClient,
...
type toolsServiceClient struct {
	unauthor *connect.Client[v1.UnauthorRequest, v1.ExploitResult]
	httpx    *connect.Client[v1.HttpxRequest, v1.ExploitResult]
}

// Unauthor calls yoshino_s.soar_helper.v1.ToolsService.Unauthor.
func (c *toolsServiceClient) Unauthor(ctx context.Context, req *connect.Request[v1.UnauthorRequest]) (*connect.ServerStreamForClient[v1.ExploitResult], error) {
	return c.unauthor.CallServerStream(ctx, req)
}

// Httpx calls yoshino_s.soar_helper.v1.ToolsService.Httpx.
func (c *toolsServiceClient) Httpx(ctx context.Context, req *connect.Request[v1.HttpxRequest]) (*connect.ServerStreamForClient[v1.ExploitResult], error) {
...
type ToolsServiceHandler interface {
	Unauthor(context.Context, *connect.Request[v1.UnauthorRequest], *connect.ServerStream[v1.ExploitResult]) error
	Httpx(context.Context, *connect.Request[v1.HttpxRequest], *connect.ServerStream[v1.ExploitResult]) error
}
...
func (UnimplementedToolsServiceHandler) Unauthor(context.Context, *connect.Request[v1.UnauthorRequest], *connect.ServerStream[v1.ExploitResult]) error {
...
func (UnimplementedToolsServiceHandler) Httpx(context.Context, *connect.Request[v1.HttpxRequest], *connect.ServerStream[v1.ExploitResult]) error {
