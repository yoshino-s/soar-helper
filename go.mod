module gitlab.yoshino-s.xyz/yoshino-s/soar-helper
...
require (
	...
	github.com/yoshino-s/go-framework v0.4.1
...
require (
	...
	github.com/projectdiscovery/dsl v0.2.3 // indirect
	...
	github.com/projectdiscovery/rawhttp v0.1.66 // indirect
